package com.shuzichuan.log.kpi;
...
public class KPITime {
    ...
    public static void main(String[] args) throws Exception {
        String input = "hdfs://192.168.10.106:9000/user/hadoop/log_kpi";
        String output = "hdfs://192.168.10.106:9000/user/hadoop/log_kpi/time";
